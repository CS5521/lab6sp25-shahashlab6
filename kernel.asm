...
80104483:	e9 43 01 00 00       	jmp    801045cb <fork+0x16c>
  }
...
8010449a:	e8 81 3b 00 00       	call   80108020 <copyuvm>
...
801044d6:	e9 f0 00 00 00       	jmp    801045cb <fork+0x16c>
  }
  np->sz = curproc->sz;
...
8010458b:	e8 a7 0c 00 00       	call   80105237 <safestrcpy>
...
801045a0:	e8 00 08 00 00       	call   80104da5 <acquire>
...
801045b6:	e8 52 08 00 00       	call   80104e0d <release>

  fork_counter++;
801045bb:	a1 20 b6 10 80       	mov    0x8010b620,%eax
801045c0:	83 c0 01             	add    $0x1,%eax
801045c3:	a3 20 b6 10 80       	mov    %eax,0x8010b620
...
80106242:	e8 19 f1 ff ff       	call   80105360 <argint>
80106247:	85 c0                	test   %eax,%eax
80106249:	79 07                	jns    80106252 <sys_fkc+0x24>
{
return -1;
8010624b:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106250:	eb 1d                	jmp    8010626f <sys_fkc+0x41>
}

if(flag ==0)
80106252:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106255:	85 c0                	test   %eax,%eax
80106257:	75 11                	jne    8010626a <sys_fkc+0x3c>
{
fork_counter = 0;
80106259:	c7 05 20 b6 10 80 00 	movl   $0x0,0x8010b620
80106260:	00 00 00 
return 0;
80106263:	b8 00 00 00 00       	mov    $0x0,%eax
80106268:	eb 05                	jmp    8010626f <sys_fkc+0x41>
}

return fork_counter;
8010626a:	a1 20 b6 10 80       	mov    0x8010b620,%eax
}
8010626f:	c9                   	leave  
80106270:	c3                   	ret    
...
80106274:	83 ec 08             	sub    $0x8,%esp
  return fork();
80106277:	e8 e3 e1 ff ff       	call   8010445f <fork>
}
8010627c:	c9                   	leave  
8010627d:	c3                   	ret    
...
cprintf("hello world!\n");
80106284:	c7 04 24 3f 87 10 80 	movl   $0x8010873f,(%esp)
8010628b:	e8 38 a1 ff ff       	call   801003c8 <cprintf>
return 0;
...
8010629a:	83 ec 08             	sub    $0x8,%esp
  exit();
8010629d:	e8 31 e3 ff ff       	call   801045d3 <exit>
...
801062ac:	83 ec 08             	sub    $0x8,%esp
  return wait();
801062af:	e8 29 e4 ff ff       	call   801046dd <wait>
}
801062b4:	c9                   	leave  
801062b5:	c3                   	ret    
...
801062b9:	83 ec 28             	sub    $0x28,%esp
  int pid;

  if(argint(0, &pid) < 0)
801062bc:	8d 45 f4             	lea    -0xc(%ebp),%eax
801062bf:	89 44 24 04          	mov    %eax,0x4(%esp)
801062c3:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801062ca:	e8 91 f0 ff ff       	call   80105360 <argint>
801062cf:	85 c0                	test   %eax,%eax
801062d1:	79 07                	jns    801062da <sys_kill+0x24>
    return -1;
801062d3:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801062d8:	eb 0b                	jmp    801062e5 <sys_kill+0x2f>
  return kill(pid);
801062da:	8b 45 f4             	mov    -0xc(%ebp),%eax
801062dd:	89 04 24             	mov    %eax,(%esp)
801062e0:	e8 cd e7 ff ff       	call   80104ab2 <kill>
}
801062e5:	c9                   	leave  
801062e6:	c3                   	ret    
...
801062ea:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
801062ed:	e8 6f de ff ff       	call   80104161 <myproc>
801062f2:	8b 40 10             	mov    0x10(%eax),%eax
}
801062f5:	c9                   	leave  
801062f6:	c3                   	ret    
...
8010630b:	e8 50 f0 ff ff       	call   80105360 <argint>
80106310:	85 c0                	test   %eax,%eax
80106312:	79 07                	jns    8010631b <sys_sbrk+0x24>
    return -1;
80106314:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106319:	eb 23                	jmp    8010633e <sys_sbrk+0x47>
  addr = myproc()->sz;
8010631b:	e8 41 de ff ff       	call   80104161 <myproc>
80106320:	8b 00                	mov    (%eax),%eax
80106322:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(growproc(n) < 0)
80106325:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106328:	89 04 24             	mov    %eax,(%esp)
8010632b:	e8 91 e0 ff ff       	call   801043c1 <growproc>
80106330:	85 c0                	test   %eax,%eax
80106332:	79 07                	jns    8010633b <sys_sbrk+0x44>
    return -1;
80106334:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106339:	eb 03                	jmp    8010633e <sys_sbrk+0x47>
  return addr;
...
80106354:	e8 07 f0 ff ff       	call   80105360 <argint>
80106359:	85 c0                	test   %eax,%eax
8010635b:	79 07                	jns    80106364 <sys_sleep+0x24>
    return -1;
8010635d:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106362:	eb 6b                	jmp    801063cf <sys_sleep+0x8f>
  acquire(&tickslock);
80106364:	c7 04 24 e0 5c 11 80 	movl   $0x80115ce0,(%esp)
8010636b:	e8 35 ea ff ff       	call   80104da5 <acquire>
  ticks0 = ticks;
80106370:	a1 20 65 11 80       	mov    0x80116520,%eax
80106375:	89 45 f4             	mov    %eax,-0xc(%ebp)
  while(ticks - ticks0 < n){
80106378:	eb 33                	jmp    801063ad <sys_sleep+0x6d>
    if(myproc()->killed){
8010637a:	e8 e2 dd ff ff       	call   80104161 <myproc>
8010637f:	8b 40 24             	mov    0x24(%eax),%eax
80106382:	85 c0                	test   %eax,%eax
80106384:	74 13                	je     80106399 <sys_sleep+0x59>
      release(&tickslock);
80106386:	c7 04 24 e0 5c 11 80 	movl   $0x80115ce0,(%esp)
8010638d:	e8 7b ea ff ff       	call   80104e0d <release>
      return -1;
80106392:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106397:	eb 36                	jmp    801063cf <sys_sleep+0x8f>
    }
    sleep(&ticks, &tickslock);
80106399:	c7 44 24 04 e0 5c 11 	movl   $0x80115ce0,0x4(%esp)
801063a0:	80 
801063a1:	c7 04 24 20 65 11 80 	movl   $0x80116520,(%esp)
801063a8:	e8 06 e6 ff ff       	call   801049b3 <sleep>
  while(ticks - ticks0 < n){
801063ad:	a1 20 65 11 80       	mov    0x80116520,%eax
801063b2:	2b 45 f4             	sub    -0xc(%ebp),%eax
801063b5:	89 c2                	mov    %eax,%edx
801063b7:	8b 45 f0             	mov    -0x10(%ebp),%eax
801063ba:	39 c2                	cmp    %eax,%edx
801063bc:	72 bc                	jb     8010637a <sys_sleep+0x3a>
  }
  release(&tickslock);
801063be:	c7 04 24 e0 5c 11 80 	movl   $0x80115ce0,(%esp)
801063c5:	e8 43 ea ff ff       	call   80104e0d <release>
  return 0;
...
801063d4:	83 ec 28             	sub    $0x28,%esp
  ...
  acquire(&tickslock);
801063d7:	c7 04 24 e0 5c 11 80 	movl   $0x80115ce0,(%esp)
801063de:	e8 c2 e9 ff ff       	call   80104da5 <acquire>
  xticks = ticks;
801063e3:	a1 20 65 11 80       	mov    0x80116520,%eax
801063e8:	89 45 f4             	mov    %eax,-0xc(%ebp)
  release(&tickslock);
801063eb:	c7 04 24 e0 5c 11 80 	movl   $0x80115ce0,(%esp)
801063f2:	e8 16 ea ff ff       	call   80104e0d <release>
  return xticks;
